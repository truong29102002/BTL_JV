...
public class QLSP extends javax.swing.JFrame {
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemMoiActionPerformed
        ...
        sp = new SanPham(txtMaSP.getText(), txtTenSP.getText(), cboSize.getSelectedItem().toString(), Integer.parseInt(txtSlcon.getText()), Double.parseDouble(txtDonGia.getText()));
        if (dssp.contains(sp)) {
            JOptionPane.showMessageDialog(this, "Ma san pham da co", "Thong bao", 1);
        } else {
            dssp.add(sp);
        }
        loadTableSP();
